...
class ProviderOrderDetailModal extends React.Component {
    ...
    getOrderDetailManage = async() => {
        ...
        try {
            ...
            let res = await axios.get(
                `${this.baseUrl}/api/Orders/${orderId}/detail-manage`,
                {
...
export default connect(mapStateToProps)(withRouter(ProviderOrderDetailModal));