          ...
          <div className="header">
            {
              ...
              !(
                ...
                <h3 className="result-text">
                  {selectedPlace.placeName}: {totalCount} tours found!
                </h3>
              ) : (
...
const backgroundImagesData = [
  {
    id: 1,
    url: "https://hoianexpress.com.vn/wp-content/uploads/2019/10/BP_3242-Edit.jpg",
  },
  {
    id: 2,
    url: "https://hoianexpress.com.vn/wp-content/uploads/2020/03/slide4-1.jpg",
  },
];
